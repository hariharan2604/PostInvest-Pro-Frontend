...
export default function CollectionPendingModal({ isOpen, onClose, customer_id }) {
                ...
                if (res.ok && data) {
                    ...
                    setBanks(
                        bank_detail.map((item) => ({
                            ...
                            label: String(`${item.bank_name} (${item.code})`),
                        }))
                    );
                }
            } catch (error) {
    ...
    useEffect(() => {
        if (isCash) {
            ...
            updateFormData({
                chequeType: "single", 
                inputFields: formData.inputFields.length > 0
                            ...
                            <>
                                ...
                                <div className={styles["form-group"]}>
                                    <Selectdropdown
                                        ...
                                        setSelectedOption={(value) => handleSelectDropdownChange(index, value)}
                                ...
                                <div className={styles["form-group"]}>
                                    <div className={styles["radioGroup"]}>
                                        ...
                                        <RadioButton
                                            ...
                                            onChange={() => handleInstrumentChange(index, INSTRUMENT_CLASSES.DOP)}
                                        />
                                        <RadioButton
                                            variant="radiobtns"
                                            id={`others-${index}`}
                                            ...
                                            checkedValue={inputField.instrument_class_id}
                                            onChange={() => handleInstrumentChange(index, INSTRUMENT_CLASSES.OTHERS)}
                                        />
                                    </div>
                                </div>
                                <div className={styles["form-group"]}>
